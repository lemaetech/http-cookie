...
let print_date_time dt =
  Format.fprintf Format.std_formatter "%a" Http_cookie.pp_date_time dt
...
let%expect_test "date_time: year 0 " =
  ...
  in
  print_date_time dt ; [%expect.unreachable]
  [@@expect.uncaught_exn
    {| ("Http_cookie.Cookie(\"Invalid year (>0 && < 9999): 0\")") |}]
...
let%expect_test "date_time: year 10000" =
  ...
  print_date_time dt ; [%expect.unreachable]
  [@@expect.uncaught_exn
    {| ("Http_cookie.Cookie(\"Invalid year (>0 && < 9999): 10000\")") |}]
...
let%expect_test "date_time: year 2021" =
  let dt =
    Http_cookie.date_time ~year:2021 ~month:`Jan ~weekday:`Sun ~day_of_month:23
      ~hour:22 ~minutes:45 ~seconds:59
  in
  print_date_time dt ; [%expect {| Sun, 23 Jan 2021 22:45:59 GMT |}]
...
let%expect_test "date_time: day_of_month 0" =
  ...
  print_date_time dt ; [%expect.unreachable]
  [@@expect.uncaught_exn
    {| ("Http_cookie.Cookie(\"Invalid day of month ( > 0 && <= 31): 0\")") |}]
...
let%expect_test "date_time: day_of_month 31" =
  let dt =
    Http_cookie.date_time ~year:2021 ~month:`Jan ~weekday:`Sun ~day_of_month:31
      ~hour:22 ~minutes:45 ~seconds:59
  in
  print_date_time dt ; [%expect {| Sun, 31 Jan 2021 22:45:59 GMT |}]
...
let%expect_test "date_time: day_of_month 32" =
  ...
  print_date_time dt ; [%expect.unreachable]
  [@@expect.uncaught_exn
    {| ("Http_cookie.Cookie(\"Invalid day of month ( > 0 && <= 31): 32\")") |}]
...
let%expect_test "date_time: hour 0" =
  ...
  print_date_time dt ; [%expect.unreachable]
  [@@expect.uncaught_exn
    {| ("Http_cookie.Cookie(\"Invalid hour (>0 && <24): 0\")") |}]
...
let%expect_test "date_time: hour 24" =
  ...
  print_date_time dt ; [%expect.unreachable]
  [@@expect.uncaught_exn
    {| ("Http_cookie.Cookie(\"Invalid hour (>0 && <24): 24\")") |}]
...
let%expect_test "date_time: hour 22" =
  let dt =
    Http_cookie.date_time ~year:2021 ~month:`Jan ~weekday:`Sun ~day_of_month:30
      ~hour:22 ~minutes:45 ~seconds:59
  in
  print_date_time dt ; [%expect {| Sun, 30 Jan 2021 22:45:59 GMT |}]
...
let%expect_test "date_time: minute 0" =
  ...
  in
  print_date_time dt ; [%expect {| Sun, 30 Jan 2021 22:00:59 GMT |}]
...
let%expect_test "date_time:minute 24" =
  ...
  in
  print_date_time dt ; [%expect {| Sun, 30 Jan 2021 22:24:59 GMT |}]
...
let%expect_test "date_time: minute 60" =
  ...
  print_date_time dt ; [%expect.unreachable]
  [@@expect.uncaught_exn
    {| ("Http_cookie.Cookie(\"Invalid minutes (>=0 && < 60): 60\")") |}]
...
let%expect_test "date_time: seconds 0" =
  ...
  in
  print_date_time dt ; [%expect {| Sun, 30 Jan 2021 22:24:00 GMT |}]
...
let%expect_test "date_time: seconds 60" =
  ...
  print_date_time dt ; [%expect.unreachable]
  [@@expect.uncaught_exn
    {| ("Http_cookie.Cookie(\"Invalid seconds (>=0 && < 60): 60\")") |}]
...
let%expect_test "date_time: seconds -1" =
  ...
  print_date_time dt ; [%expect.unreachable]
  [@@expect.uncaught_exn
    {| ("Http_cookie.Cookie(\"Invalid seconds (>=0 && < 60): -1\")") |}]
